-- Add tenant isolation to agent registry
-- This allows each tenant to manage their own agents
...
comment on column nofx.agent_registry.tenant_id is
  'Tenant ID for multi-tenancy. Each tenant can only see/manage their own agents.';
