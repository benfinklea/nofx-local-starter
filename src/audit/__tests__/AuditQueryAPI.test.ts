    ...
    mockEvents = [
      {
        ...
        subject: { resource_type: 'user', resource_id: 'user_1', organization_id: 'org_123' },
      ...
      },
      {
        ...
        subject: { resource_type: 'user', resource_id: 'user_2', organization_id: 'org_123' },
      ...
      },
      {
        ...
        subject: { resource_type: 'system', organization_id: 'org_123' },
        outcome: EventOutcome.FAILURE,
        context: { ip_address: '192.168.1.100' },
      },
      {
        ...
        subject: { resource_type: 'user', resource_id: 'user_4', organization_id: 'org_123' },
        outcome: EventOutcome.FAILURE,
        context: { ip_address: '192.168.1.100' },
      },
      {
        ...
        severity: EventSeverity.INFO,
        actor: { user_id: 'user_1' },
        subject: { resource_type: 'organization_member', resource_id: 'user_5', organization_id: 'org_123' },
        outcome: EventOutcome.SUCCESS,
